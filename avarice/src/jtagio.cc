...
jtag_device_def_type deviceDefinitions[] = {
    {
        ...
        4,   128,    // 512 bytes EEPROM
        {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x31, 0x57, 0x00,  128,    0,    0, 0x80, 0x1F,
            0x00, 0x00, 0,
            JTAG_EOM
        }
    },
    // DEV_ATMEGA_162
    {
        ...
        4,   128,    // 512 bytes EEPROM
        {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x02, 0x18, 0x00, 0x20,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x04, 0x57, 0x00,  128,    0,    4, 0x80, 0x1F,
            0x00, 0x00, 0x8B,
            JTAG_EOM
        }
    },
    // DEV_ATMEGA_169
    {
        ...
        4,   128,    // 512 bytes EEPROM
        {
            ...
            0xF0, 0xF0, 0xDE, 0x7B, 0x43, 0xDA, 0x00, 0xFF,
            0xF7, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x4D, 0x05,
            0x36, 0x00, 0x00, 0x00, 0xE0, 0xF0, 0xDE, 0x7B,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x31, 0x57, 0x00,  128,    0,    4, 0x80, 0x1F,
            0x00, 0x00, 0xFE,
            JTAG_EOM
        }
    },
    // DEV_ATMEGA_323
    {
        ...
        4,   256,    // 1K EEPROM
        {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x31, 0x57, 0x00,  128,    0,    0, 0x00, 0x3F,
            0x00, 0x00, 0,
            JTAG_EOM
        }
    },
    // DEV_ATMEGA_32
    {
        ...
        4,   256,    // 1K EEPROM
        {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x31, 0x57, 0x00,  128,    0,    4, 0x00, 0x3F,
            0x00, 0x00, 0,
            JTAG_EOM
        }
    },
#if 0
    /* TRoth 2003-03-25: the values in the dev_desc array where just copied
       from the mega32. */
    ...
    // DEV_ATMEGA_128
    {
        ...
        4,   128,    // 512 bytes EEPROM
        {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x3E, 0xB5, 0x0F, 0x27,
            0xFF, 0x1F, 0x21, 0x27, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x22, 0x68, 0x3B,    0,    1,    8, 0x00, 0xFE,
            0x00, 0x00, 0x9D,
            JTAG_EOM
        }
    },
