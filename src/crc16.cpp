...
unsigned short Crc16::Checksum(const unsigned char *message, unsigned long length, unsigned short crc) {
...
bool Crc16::VerifyChecksum(
    const unsigned char *message,
    unsigned long length) { // Returns true if the last two bytes in a message is the crc
...
void Crc16::AppendChecksum(unsigned char *message, unsigned long length) {
