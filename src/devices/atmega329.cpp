...
constexpr gdb_io_reg_def_type atmega329_io_registers[] = {
    ...
    {"TCNT2", 0xb2, 0x00},      {"OCR2A", 0xb3, 0x00},   {"ASSR", 0xb6, 0x00},
    {"USICR", 0xb8, 0x00},      {"USISR", 0xb9, 0x00},   {"USIDR", 0xba, 0x00},
    {"UCSR0A", 0xc0, 0x00},     {"UCSR0B", 0xc1, 0x00},  {"UCSR0C", 0xc2, 0x00},
    {"UBRR0L", 0xc4, 0x00},     {"UBRR0H", 0xc5, 0x00},  {"UDR0", 0xc6, IO_REG_RSE},
    {"LCDCRA", 0xe4, 0x00},     {"LCDCRB", 0xe5, 0x00},  {"LCDFRR", 0xe6, 0x00},
    {"LCDCCR", 0xe7, 0x00},     {"LCDDR00", 0xec, 0x00}, {"LCDDR01", 0xed, 0x00},
    {"LCDDR02", 0xee, 0x00},    {"LCDDR03", 0xef, 0x00}, {"LCDDR05", 0xf1, 0x00},
...
[[maybe_unused]] const jtag_device_def_type atmega329{
    "atmega329",
    0x9503,
    128,
    256, // 32K flash
