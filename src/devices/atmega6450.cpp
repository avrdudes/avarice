...
constexpr gdb_io_reg_def_type atmega6450_io_registers[] = {
    ...
    {"DDRJ", 0xdc, 0x00},   {"PORTJ", 0xdd, 0x00},      {nullptr, 0, 0}};

[[maybe_unused]] const jtag_device_def_type atmega6450{
    "atmega6450",
    0x9606,
    256,
