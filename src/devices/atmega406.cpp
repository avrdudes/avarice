...
constexpr gdb_io_reg_def_type atmega406_io_registers[] = {
    ...
    {"PORTC", 0x28, 0x00},   {"PIND", 0x29, 0x00},    {"DDRD", 0x2a, 0x00},
    {"PORTD", 0x2b, 0x00},   {"TIFR0", 0x35, 0x00},   {"TIFR1", 0x36, 0x00},
    ...
    {"GPIOR2", 0x4b, 0x00},  {"OCDR", 0x51, 0x00},    {"SMCR", 0x53, 0x00},
    {"MCUSR", 0x54, 0x00},   {"MCUCR", 0x55, 0x00},   {"SPMCSR", 0x57, 0x00},
    {"SPL", 0x5d, 0x00},     {"SPH", 0x5e, 0x00},     {"SREG", 0x5f, 0x00},
    {"WDTCSR", 0x60, 0x00},  {"WUTCSR", 0x62, 0x00},  {"PRR0", 0x64, 0x00},
    ...
    {"TCCR1B", 0x81, 0x00},  {"TCNT1L", 0x84, 0x00},  {"TCNT1H", 0x85, 0x00},
    {"OCR1AL", 0x88, 0x00},  {"OCR1AH", 0x89, 0x00},  {"TWBR", 0xb8, 0x00},
    {"TWSR", 0xb9, 0x00},    {"TWAR", 0xba, 0x00},    {"TWDR", 0xbb, 0x00},
    {"TWCR", 0xbc, 0x00},    {"TWAMR", 0xbd, 0x00},   {"TWBCSR", 0xbe, 0x00},
    {"CCSR", 0xc0, 0x00},    {"BGCCR", 0xd0, 0x00},   {"BGCRR", 0xd1, 0x00},
    {"CADAC0", 0xe0, 0x00},  {"CADAC1", 0xe1, 0x00},  {"CADAC2", 0xe2, 0x00},
    {"CADAC3", 0xe3, 0x00},  {"CADCSRA", 0xe4, 0x00}, {"CADCSRB", 0xe5, 0x00},
    {"CADRCC", 0xe6, 0x00},  {"CADRDC", 0xe7, 0x00},  {"CADICL", 0xe8, 0x00},
    {"CADICH", 0xe9, 0x00},  {"FCSR", 0xf0, 0x00},    {"CBCR", 0xf1, 0x00},
    {"BPIR", 0xf2, 0x00},    {"BPDUV", 0xf3, 0x00},   {"BPSCD", 0xf4, 0x00},
    {"BPOCD", 0xf5, 0x00},   {"CBPTR", 0xf6, 0x00},   {"BPCR", 0xf7, 0x00},
    {"BPPLR", 0xf8, 0x00},   {nullptr, 0, 0}};
