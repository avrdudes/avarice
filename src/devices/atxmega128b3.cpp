...
constexpr xmega_device_desc_type xmega_device_desc{
    ...
    131072,    // size of application flash
    8192,      // size of boot flash
    256,       // flash page size
    2048,      // size of EEPROM
    32,        // EEPROM page size
