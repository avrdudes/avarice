...
constexpr gdb_io_reg_def_type atmega1284p_io_registers[] = {
    ...
    {"SPSR", 0x4d, 0x00},       {"SPDR", 0x4e, 0x00},       {"ACSR", 0x50, 0x00},
    {"OCDR", 0x51, 0x00},       {"SMCR", 0x53, 0x00},       {"MCUSR", 0x54, 0x00},
    {"MCUCR", 0x55, 0x00},      {"SPMCSR", 0x57, 0x00},     {"RAMPZ", 0x5b, 0x00},
    ...
    {"TIMSK2", 0x70, 0x00},     {"TIMSK3", 0x71, 0x00},     {"PCMSK3", 0x73, 0x00},
    ...
    {"TCCR3A", 0x90, 0x00},     {"TCCR3B", 0x91, 0x00},     {"TCCR3C", 0x92, 0x00},
    {"TCNT3L", 0x94, 0x00},     {"TCNT3H", 0x95, 0x00},     {"ICR3L", 0x96, 0x00},
    {"ICR3H", 0x97, 0x00},      {"OCR3AL", 0x98, 0x00},     {"OCR3AH", 0x99, 0x00},
    {"OCR3BL", 0x9a, 0x00},     {"OCR3BH", 0x9b, 0x00},     {"TCCR2A", 0xb0, 0x00},
...
[[maybe_unused]] const jtag_device_def_type atmega1284p{
    "atmega1284p",
    0x9705,
    256,
