...
constexpr gdb_io_reg_def_type atmega32c1_io_registers[] = {
    ...
    {"TIFR0", 0x35, 0x00},    {"TIFR1", 0x36, 0x00},      {"GPIOR1", 0x39, 0x00},
    {"GPIOR2", 0x3a, 0x00},   {"PCIFR", 0x3b, 0x00},      {"EIFR", 0x3c, 0x00},
    ...
    {"PLLCSR", 0x49, 0x00},   {"SPCR", 0x4c, 0x00},       {"SPSR", 0x4d, 0x00},
    ...
    {"PRR", 0x64, 0x00},      {"OSCCAL", 0x66, 0x00},     {"PCICR", 0x68, 0x00},
    {"EICRA", 0x69, 0x00},    {"PCMSK0", 0x6a, 0x00},     {"PCMSK1", 0x6b, 0x00},
    {"PCMSK2", 0x6c, 0x00},   {"PCMSK3", 0x6d, 0x00},     {"TIMSK0", 0x6e, 0x00},
    {"TIMSK1", 0x6f, 0x00},   {"AMP0CSR", 0x75, 0x00},    {"AMP1CSR", 0x76, 0x00},
    {"AMP2CSR", 0x77, 0x00},  {"ADCL", 0x78, IO_REG_RSE}, {"ADCH", 0x79, IO_REG_RSE},
    ...
    {"OCR1BH", 0x8b, 0x00},   {"DACON", 0x90, 0x00},      {"DACL", 0x91, 0x00},
    {"DACH", 0x92, 0x00},     {"AC0CON", 0x94, 0x00},     {"AC1CON", 0x95, 0x00},
    {"AC2CON", 0x96, 0x00},   {"AC3CON", 0x97, 0x00},     {"LINCR", 0xc8, 0x00},
    {"LINSIR", 0xc9, 0x00},   {"LINENIR", 0xca, 0x00},    {"LINERR", 0xcb, 0x00},
    {"LINBTR", 0xcc, 0x00},   {"LINBRRL", 0xcd, 0x00},    {"LINBRRH", 0xce, 0x00},
    {"LINDLR", 0xcf, 0x00},   {"LINIDR", 0xd0, 0x00},     {"LINSEL", 0xd1, 0x00},
    {"LINDAT", 0xd2, 0x00},   {"CANGCON", 0xd8, 0x00},    {"CANGSTA", 0xd9, 0x00},
    {"CANGIT", 0xda, 0x00},   {"CANGIE", 0xdb, 0x00},     {"CANEN2", 0xdc, 0x00},
    {"CANEN1", 0xdd, 0x00},   {"CANIE2", 0xde, 0x00},     {"CANIE1", 0xdf, 0x00},
    {"CANSIT2", 0xe0, 0x00},  {"CANSIT1", 0xe1, 0x00},    {"CANBT1", 0xe2, 0x00},
    {"CANBT2", 0xe3, 0x00},   {"CANBT3", 0xe4, 0x00},     {"CANTCON", 0xe5, 0x00},
    {"CANTIML", 0xe6, 0x00},  {"CANTIMH", 0xe7, 0x00},    {"CANTTCL", 0xe8, 0x00},
    {"CANTTCH", 0xe9, 0x00},  {"CANTEC", 0xea, 0x00},     {"CANREC", 0xeb, 0x00},
    {"CANHPMOB", 0xec, 0x00}, {"CANPAGE", 0xed, 0x00},    {"CANSTMOB", 0xee, 0x00},
    {"CANCDMOB", 0xef, 0x00}, {"CANIDT4", 0xf0, 0x00},    {"CANIDT3", 0xf1, 0x00},
    {"CANIDT2", 0xf2, 0x00},  {"CANIDT1", 0xf3, 0x00},    {"CANIDM4", 0xf4, 0x00},
    {"CANIDM3", 0xf5, 0x00},  {"CANIDM2", 0xf6, 0x00},    {"CANIDM1", 0xf7, 0x00},
    {"CANSTML", 0xf8, 0x00},  {"CANSTMH", 0xf9, 0x00},    {"CANMSG", 0xfa, 0x00},
    {nullptr, 0, 0}};

[[maybe_unused]] const jtag_device_def_type atmega32c1{
    "atmega32c1",
    0x9586,
    128,
