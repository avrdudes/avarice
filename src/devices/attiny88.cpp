...
constexpr gdb_io_reg_def_type attiny88_io_registers[] = {
    ...
    {"PINA", 0x2c, 0x00},   {"DDRA", 0x2d, 0x00},       {"PORTA", 0x2e, 0x00},
    {"PORTCR", 0x32, 0x00}, {"TIFR0", 0x35, 0x00},      {"TIFR1", 0x36, 0x00},
    {"PCIFR", 0x3b, 0x00},  {"EIFR", 0x3c, 0x00},       {"EIMSK", 0x3d, 0x00},
    {"GPIOR0", 0x3e, 0x00}, {"EECR", 0x3f, 0x00},       {"EEDR", 0x40, 0x00},
    {"EEARL", 0x41, 0x00},  {"GTCCR", 0x43, 0x00},      {"TCCR0A", 0x45, 0x00},
    ...
    {"EICRA", 0x69, 0x00},  {"PCMSK3", 0x6a, 0x00},     {"PCMSK0", 0x6b, 0x00},
    {"PCMSK1", 0x6c, 0x00}, {"PCMSK2", 0x6d, 0x00},     {"TIMSK0", 0x6e, 0x00},
    {"TIMSK1", 0x6f, 0x00}, {"ADCL", 0x78, IO_REG_RSE}, {"ADCH", 0x79, IO_REG_RSE},
    ...
    {"OCR1BH", 0x8b, 0x00}, {"TWBR", 0xb8, 0x00},       {"TWSR", 0xb9, 0x00},
    {"TWAR", 0xba, 0x00},   {"TWDR", 0xbb, 0x00},       {"TWCR", 0xbc, 0x00},
    {"TWAMR", 0xbd, 0x00},  {"TWHSR", 0xbe, 0x00},      {nullptr, 0, 0}};
